///campaign/augsoc2/public/campaign/augsoc2/public/assets/
...
function setupManifest() {
    ...
    createjs.Sound.registerSound({src: "/campaign/augsoc2/public/assets/images/bgm0.mp3",id: "bgm0"});
	createjs.Sound.registerSound({src: "/campaign/augsoc2/public/assets/images/bgm1.mp3",id: "bgm1"});
	createjs.Sound.registerSound({src: "/campaign/augsoc2/public/assets/images/bgm2.mp3",id: "bgm2"});
	createjs.Sound.registerSound({src: "/campaign/augsoc2/public/assets/images/bgm3.mp3",id: "bgm3"});
	createjs.Sound.registerSound({src: "/campaign/augsoc2/public/assets/images/bgm4.mp3",id: "bgm4"});
	createjs.Sound.registerSound({src: "/campaign/augsoc2/public/assets/images/bgm5.mp3",id: "bgm5"});
	createjs.Sound.registerSound({src: "/campaign/augsoc2/public/assets/images/bgm6.mp3",id: "bgm6"});

    manifest = [];
	manifest.push({
        src: "/campaign/augsoc2/public/assets/images/btn.png"
    });
    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/page1Img1.png"
    });
    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/page1Img1b.png"
    });
    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/topArrow.png"
    });
    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/shareNote.png"
    });

    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/a1/act.png"
    });

    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/page3Img1.png"
    });
    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/page4Img11.png"
    });
    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/page4Img12.png"
    });
    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/page4Img13.png"
    });
    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/page4Img14.png"
    });
    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/page4Img15.png"
    });
    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/page4Img16.png"
    });

    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/page5Img11.png"
    });
    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/page5Img12.png"
    });
    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/page5Img13.png"
    });

    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/page6Img1.png"
    });
    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/page7Img1.png"
    });
    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/page8Img1.png"
    });
    manifest.push({
        src: "/campaign/augsoc2/public/assets/images/page9Img1.png"
    });
...
function setupManifest2() {
    ...
    for (var j = 1; j <= 87; j=j+2) {
        if (j < 10) {
            manifest2.push({
                src: "/campaign/augsoc2/public/assets/images/b1/b0" + j + ".png"
            });
        } else {
            manifest2.push({
                src: "/campaign/augsoc2/public/assets/images/b1/b" + j + ".png"
            });
        }
    }
    startPreload2();
...
function setupManifest3() {
    ...
    for (var i = 1; i <= 65; i=i+2) {
        if (i < 10) {
            manifest3.push({
                src: "/campaign/augsoc2/public/assets/images/a2/a0" + i + ".png"
            });
        } else {
            manifest3.push({
                src: "/campaign/augsoc2/public/assets/images/a2/a" + i + ".png"
            });
        }
    }
...
for (var i = 1; i <= act2Numb + act2roolNumb; i=i+2) {
    if (i < 10) {
        act2Arr.push("/campaign/augsoc2/public/assets/images/a2/a0" + i + ".png");
    } else if (i <= act2Numb) {
        act2Arr.push("/campaign/augsoc2/public/assets/images/a2/a" + i + ".png");
    } else {
        act2Arr.push("/campaign/augsoc2/public/assets/images/a2/a" + (act2Numb - i + act2Numb) + ".png");
    }
}
...
for (var j = 1; j <= act3Numb; j=j+2) {
    if (j < 10) {
        act3Arr.push("/campaign/augsoc2/public/assets/images/b1/b0" + j + ".png");
    } else {
        act3Arr.push("/campaign/augsoc2/public/assets/images/b1/b" + j + ".png");
    }
}
...
for (var l = act4Numb; l <= act4Numb2; l=l+2) {
    if (l < 10) {
        act4Arr.push("/campaign/augsoc2/public/assets/images/b1/b0" + l + ".png");
    } else {
        act4Arr.push("/campaign/augsoc2/public/assets/images/b1/b" + l + ".png");
    }
}
    ...
    $.ajax(actUrl, {
        ...
        success: function(json) {
            ...
            if(json && json.prize && json.prize > 0){
				...
				$('.endImg').attr('src', '/campaign/augsoc2/public/assets/images/' + rNumb + '.gif');
...
function act1() {
    ...
    var spriteSheet = new createjs.SpriteSheet({
        framerate: 4,
        "images": ["/campaign/augsoc2/public/assets/images/a1/act.png"],
        "frames": {
            "regX": 0,
            "height": 1109,
            "count": 7,
    ...
    downArrow = new createjs.Bitmap("/campaign/augsoc2/public/assets/images/topArrow.png");
    downArrow.x = 275;
    downArrow.y = 950;

	btn = new createjs.Bitmap("/campaign/augsoc2/public/assets/images/btn.png");
    btn.x = 450;
    btn.y = 750;
