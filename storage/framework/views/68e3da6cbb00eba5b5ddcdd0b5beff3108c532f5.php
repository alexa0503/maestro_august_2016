    ...
    <div class="login-panel panel panel-default plain animated bounceIn">
        ...
        <div class="panel-heading">
            <h4 class="panel-title text-center">
                <!--<img id="logo" src="<?php echo e(asset('assets/cms/img/logo-dark.png')); ?>"alt="Dynamic logo">-->
                <?php echo e(env('PAGE_TITLE')); ?> - 后台管理
            </h4>
        </div>
        <div class="panel-body">
            <form class="form-horizontal mt0" method="post" action="<?php echo e(url('/admin/login')); ?>" id="login-form" role="form">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                    <div class="col-lg-12">
                        <div class="input-group input-icon">
                            ...
                            <input type="text" name="email" id="email" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="您的Email ...">
                            <?php if($errors->has('email')): ?>
                                <label id="email-error" class="help-block" for="email"><?php echo e($errors->first('email')); ?></label>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="input-group input-icon">
                            ...
                            <?php if($errors->has('password')): ?>
                                <label id="password-error" class="help-block" for="password"><?php echo e($errors->first('password')); ?></label>
                            <?php endif; ?>
                        </div>
...
<!-- Form plugins -->
<script src="<?php echo e(asset('assets/cms/plugins/forms/validation/jquery.validate.js')); ?>"></script>
<script src="<?php echo e(asset('assets/cms/plugins/forms/validation/additional-methods.min.js')); ?>"></script>
<!-- Init plugins olny for this page -->
<script src="<?php echo e(asset('assets/cms/js/pages/login.js')); ?>"></script>
